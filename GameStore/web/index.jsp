        ...
        <div class="Connexion" >
            <% 
                if(session.getAttribute("nom_utilisateur")!=null)
               {
                ...
                {
                 out.println("<a href=./connexion>Se connecter</a><form action=\"ServletControleur\" method=\"post\"><label for=\"identifiant\"></label><input type=\"text\" name=\"identifiant\" id=\"identifiant\" placeholder=\"Identifiant\"/><label for=\"mdp\"></label></br><input type=\"password\" name=\"mdp\" id=\"mdp\" placeholder=\"Mot de passe\"/><input type=\"submit\" value=\"Valider\"></form>");       
                }   
             %>
        </div>
        </div>
