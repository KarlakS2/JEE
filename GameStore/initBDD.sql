...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Crash Bandicoot',
                80,
                'Crash Bandicoot sur Playstation est un jeu de plates-formes dans lequel vous incarnez un animal peu commun et complètement loufoque. Lami Crash, cest son petit nom, va devoir traverser 32 niveaux répartis en trois îles pour lutter contre linfâme Dr Neo Cortex. Affrontez les ennemis en tournoyant sur vous-même comme une toupie et ramassez les diamants de chaque tableau.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Final Fantasy X',
                55,
                'Final Fantasy X est un jeu de rôle sorti sur Playstation 2. Le monde de Spira vit dans la crainte dune entité maléfique nommée Sin. Vous incarnez une équipe menée par le jeune Tidus dans une quête pour libérer la terre de loppression, uniquement possible au prix dune invocation finale...',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Grand Theft Auto San Andreas',
                12,
                'GTA : San Andreas sur PS2 est un jeu daction dans lequel vous dirigez Carl Johnson, une petite frappe revenue dans sa ville natale. Vous découvrez que la dure loi des gangs règne et il vous faut vous créer un nom et une réputation pour gagner en respect. La zone de jeu est immense et se compose de trois grandes villes pour accomplir des missions. Meurtres, corruption, vols, trahison... Trouvez votre place à Los Santos !',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
 ...
 INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Heavy Rain',
                19,
                'Heavy Rain sur Playstation 3 est un jeu daventure. Vous incarnez 4 personnages différents ayant tous un lien avec le tueur à lOrigami. Chacun tente denquêter sur lidentité du criminel. Le jeu se présente sous la forme de phases dexploration et dactions durant lesquelles le joueur doit réaliser des actions contextuelles pour effectuer ses actions. Le titre autorise un choix conséquent dactions ce qui permet quasiment dagir dans le jeu comme dans la réalité.',
 ...
 INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Grand Theft Auto V',
                37,
                'Dans Grand Theft Auto V sur PS3, jeu en monde ouvert, le joueur enchaîne braquages et missions en incarnant alternativement ou simultanément 3 personnages pour la première fois dans lhistoire de la série : Michael, Trevor et Franklin. Lhistoire se passe à Los Santos, lune des villes de la région de San Andreas. Le jeu propose aussi un mode multijoueur en univers persistant pouvant accueillir jusquà 16 utilisateurs dans des modes coopératifs ou compétitifs.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Watch Dogs',
                60,
                'Watch Dogs est un jeu daction à la troisième personne sur PS4. Dans un univers moderne et ouvert où tout est connecté à un système de contrôle central appartenant à des sociétés privées, le joueur incarne un groupe de hackeurs et dassassins capables de manipuler et de pirater les systèmes électroniques.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Metal Gear Solid V',
                20,
                'MGS V - Ground Zeroes sur PlayStation 4 est le prologue de The Phantom Pain. Le titre est vendu séparément et plonge le joueur dans lintroduction du 5ème épisode de la saga. En plus de la mission principale scénarisée, on retrouve 5 missions annexes visant à faire découvrir aux joueurs les subtilités du gameplay.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Titanfall',
                46,
                'Titanfall sur Xbox One est un FPS multijoueur mettant en scène laffrontement entre de puissants mechas et une infanterie lourdement armée dans un univers science-fiction. Les joueurs peuvent à tout moment bénéficier de l’appuie de leur propre titan ou "au sol" en profitant dun gameplay axé parkour ultra-dynamique.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Plantes contre Zombies : Garden Warfare',
                25,
                'Plantes contre Zombies : Garden Warfare est un jeu de tir à la première personne disponible sur Xbox 360. Le joueur y choisit son camp (les plantes ou les zombies) et sengage dans des combats délirants et drôles pouvant mêler jusquà 24 personnes.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Halo',
                50,
                'Halo sur Xbox est un jeu de tir à la première personne dont laction se déroule dans un contexte futuriste. Confrontée à une alliance extraterrestre déterminée à léradiquer, lhumanité lance dans la bataille le dernier représentant dune section de soldats génétiquement modifiés : le Master Chief. Contraint de prendre la fuite après une défaite, un petit contingent dhumains, accompagné du Master Chief, échoue sur un étrange monde artificiel en forme danneau..',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('ZombiU',
                12,
                'ZombiU est un jeu de tir à la première personne sur Wii U. Dans une ambiance survival-horror, le joueur est un des rares rescapés dune infection qui transforme les gens en zombie. A chaque mort, un changement de personnage sopère. Lancien avatar maintenant devenu un infecté peut ainsi être croisé dans les rues de Londres, cadre de laventure. Le GamePad est utilisé pour diverses fonctions : comme un radar, un sonar ou encore comme inventaire.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Final Fantasy VI',
                500,
                'Final Fantasy VI sur Super Nintendo marque un tournant dans la saga des Final Fantasy avec son côté plus sombre et tragique que précédents volets. 1000 ans après une guerre terrible, la magie a presque entièrement disparu au profit de la technologie Magitek qui donne à lEmpire le plein pouvoir sur le Monde. Les Returners, un groupe de rebelles mené par le héros Lock tente de se dresser devant la puissance de lEmpire.',
                'image/miniatureArticle/ffvimini.jpg',
                'Super NES'
                );

INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('The Legend of Zelda : Majoras Mask',
                44,
                'The Legend of Zelda : Majoras Mask est un jeu daventure/action sur Nintendo 64. Link se voit dépossédé de son Ocarina par un mystérieux personnage du nom de Skull Kid. Ce dernier lui a aussi dérobé le masque de Majora, une relique ancestrale maudite. Y a-t-il encore un moyen dempêcher lapocalypse ? Heureusement, oui ! Il vous faudra "simplement" reprendre possession du masque en lespace de trois jours, avant que la comète nentre en collision avec le monde de Termina.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Mario Kart 7',
                34,
                'Mario Kart 7 est un jeu de courses sur Nintendo 3DS. Dans la continuité de la série, le titre propose des courses folles où lutilisation dobjets a une grande importance. Grâce au nouveau deltaplane, un tas de raccourcis soffrent au joueur. Mario Kart 7 dispose aussi dun mode multi local ou en ligne.',
                'image/miniatureArticle/mariokartmini.jpg',
                '3DS'
                );

INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Professeur Layton et lEtrange Village',
                30,
                'Professeur Layton et lEtrange Village est un jeu daventure et de réflexion sur Nintendo DS. Basé sur une histoire de meurtre bizarre, le célèbre professeur va devoir trouver la clé de lénigme, mais pas seulement de celle-ci. Les habitants de St Mystère adorent poser des énigmes, à tel point que la moindre conversation anodine peut donner lieu à des puzzles, parfois évidents, parfois nettement plus ardus.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Advance Wars',
                80,
                'Advance Wars est un jeu de stratégie tactique sorti sur Gameboy Advance. Celui-ci se joue au tour par tour. Choisissez votre général avec ses capacités différentes puis bâtissez une armée afin danéantir vos adversaires.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Pokemon Rouge',
                255,
                'Pokémon Rouge est un jeu de rôle sorti sur Gameboy. Dirigez un dresseur de Pokémons qui doit devenir le meilleur dentre tous. Pour cela, capturez des créatures et faites-les évoluer pour quelles deviennent de plus en plus fortes et quelles puissent remporter la ligue Pokémon.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Pokemon Bleu',
                255,
                'Pokémon Bleu est un jeu de rôle sorti sur Gameboy. Dirigez un dresseur de Pokémons qui doit devenir le meilleur dentre tous. Pour cela, capturez des créatures et faites-les évoluer pour quelles deviennent de plus en plus fortes et quelles puissent remporter la ligue Pokémon.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Tetris',
                999,
                'Tetris sur Gameboy est le célèbre puzzle-game dans lequel vous devez empiler des briques afin de constituer des lignes qui seffaceront au fur et à mesure de votre progression. La difficulté augmente au fil de votre avancée.',
...
INSERT  INTO ARTICLE(NOM,PRIX,DESCRIPTION,URLIMAGE,CATEGORIE) 
        VALUES ('Warcraft III Reign of Chaos',
                10,
                'Warcraft III : Reign of Chaos est un jeu de stratégie sur PC qui oppose 4 factions : les morts vivants, les elfes de la nuit, les humains et les orcs. A la tête de chaque armée vous possédez 3 héros au maximum que vous pouvez faire évoluer au fur et à mesure de votre périple. Ces héros permettent dutiliser différents sorts qui peuvent sensiblement améliorer vos chances de victoire sur le champ de bataille. Le titre permet de jouer jusquà 12 joueurs en ligne ou en réseau local.',
